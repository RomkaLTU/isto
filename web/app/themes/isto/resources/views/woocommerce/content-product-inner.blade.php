...
<div>
	<div class="flex items-start justify-between">
		...
		?>
		<div x-data :class="{'remove': $store.favs.items.includes({{ $product->get_id() }})}" class="toggle-favs cursor-pointer mt-1" @click.prevent="$store.favs.toggleFav({{ $product->get_id() }})">

<form role="search" class="search-form" method="get" action="{{ get_permalink( wc_get_page_id( 'shop' ) ) }}">
    <label class="flex items-center">
        ...
        <input type="text" name="s" class="bg-transparent border-none placeholder-gray-2 text-14px outline-none focus:ring-0" placeholder="{{ __('PRODUKTŲ PAIEŠKA', 'isto') }}">

        ...
        <div class="swiper swiper-container-hero overflow-hidden relative h-590px">
            <div class="swiper-wrapper">
                @foreach ($slides as $slide)
                    ...
                    @endphp
                    <div data-swiper-slide class="swiper-slide group block bg-no-repeat bg-cover bg-center"
                        style="background-image: url({{ $bgImage }})">
                        <div data-hero-line class="hero-line bg-white w-1px h-[150px] lg:h-[300px] absolute -top-full right-0 mr-[50%] lg:mr-[38%]">
                            <div data-hero-text class="hero-text opacity-0 relative h-full">
